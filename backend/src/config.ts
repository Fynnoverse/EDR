...
export const BASE_OSRM_API = process.env.OSRM_API_URL ?? "http://localhost:5000/";
...
export const newInternalIdToSrId: {[k: string]: number} = {
    ...
    "DG_DZA": StationId.dabrowa_gornicza_zabkowice_dza,
    "DG_GTB": StationId.dabrowa_gornicza_zabkowice_gtb,
    "DG": StationId.dabrowa_gornicza,
    "DGHK": StationId.dabrowa_gornicza_huta_katowice,
    "DOR": StationId.dorota,
    "GA": StationId.gajewniki,
    "G": StationId.galkowek,
    "GL": StationId.glinnik,
    "GN": StationId.glowno,
    ...
    "PA": StationId.pabianice,
    "PI": StationId.pilichowice,
    "PL": StationId.plycwia,
    "PL_GT": StationId.plycwia_gt,
    "PRSZ": StationId.pruszkow,
    "JOZ": StationId.jozefinow,
    "PS": StationId.psary,
    "RC": StationId.raciborowice,
    "RG": StationId.rogow,
    "RO": StationId.rokiciny,
    "RT": StationId.retkinia,
    "SG_KAZ": StationId.sosnowiec_kazimierz,
    "SG_KAZ_PZS_SKZ1": StationId.sosnowiec_kazimierz_pzs_skz1,
    "SG_KAZ_PZS_SKZ2": StationId.sosnowiec_kazimierz_pzs_skz2,
    ...
    "WT": StationId.witonia,
    "ZA": StationId.zawiercie,
    "ZP": StationId.zakowice_poludniowe,
    "ZR": StationId.zyrardow,
    "ZDW": StationId.zdunska_wola,
    "ZG": StationId.zgierz,
    "ZG_PN": StationId.zgierz_polnoc,
    "ZS": StationId.zastow,
}
...
export const POSTS: { [key: string]: number[] } = {
    ...
    "DG_ZA": [newInternalIdToSrId["DG_ZA"], newInternalIdToSrId["DG_DZA"], newInternalIdToSrId["DG_GTB"]],
    "DG": [newInternalIdToSrId["DG"]],
    "DGHK": [newInternalIdToSrId["DGHK"]],
    "DOR": [newInternalIdToSrId["DOR"]],
    "GA": [newInternalIdToSrId["GA"]],
    "G": [newInternalIdToSrId["G"]],
    "GL": [newInternalIdToSrId["GL"]],
    "GN": [newInternalIdToSrId["GN"]],
    ...
    "KOL": [newInternalIdToSrId["KOL"], newInternalIdToSrId["KOL_PZS_R145"], newInternalIdToSrId["KOL_PZS_R154"]],
    "KOR": [newInternalIdToSrId["KOR"]],
    "KOZ": [newInternalIdToSrId["KOZ"]],
    "KPM": [newInternalIdToSrId["KPM"]],
    "KZ": [newInternalIdToSrId["KZ"]],
    "LA": [newInternalIdToSrId["LA"]],
    "LCH": [newInternalIdToSrId["LCH"]],
    "LUB": [newInternalIdToSrId["LUB"]],
    "LZ": [newInternalIdToSrId["LZ"], newInternalIdToSrId["LZ_GT"]],
    "LG": [
        newInternalIdToSrId["LG"],
        newInternalIdToSrId["LG_PZS_R1"],
        newInternalIdToSrId["LG_PZS_R12"],
        newInternalIdToSrId["LG_PZS_R24_R31"]
    ],
    "LP": [newInternalIdToSrId["LP"]],
    "LK": [newInternalIdToSrId["LK"], newInternalIdToSrId["LK_PZS"]],
    "LW": [newInternalIdToSrId["LW"], newInternalIdToSrId["LW_PZS_R3"]],
    "LZ_LA": [newInternalIdToSrId["LZ_LA"], newInternalIdToSrId["LZ_LGW"]],
    "LZ_LB": [newInternalIdToSrId["LZ_LB"], newInternalIdToSrId["LZ_L11"]],
    ...
    "PA": [newInternalIdToSrId["PA"]],
    "PI": [newInternalIdToSrId["PI"]],
    "PL": [newInternalIdToSrId["PL"], newInternalIdToSrId["PL_GT"]],
    "PRSZ": [newInternalIdToSrId["PRSZ"], newInternalIdToSrId["JOZ"]],
    "PS": [newInternalIdToSrId["PS"]],
    "RC": [newInternalIdToSrId["RC"]],
    "RG": [newInternalIdToSrId["RG"]],
    "RO": [newInternalIdToSrId["RO"]],
    "RT": [newInternalIdToSrId["RT"]],
    "SG_KAZ": [newInternalIdToSrId["SG_KAZ"], newInternalIdToSrId["SG_KAZ_PZS_SKZ1"], newInternalIdToSrId["SG_KAZ_PZS_SKZ2"]],
    ...
    "WT": [newInternalIdToSrId["WT"]],
    "ZA": [newInternalIdToSrId["ZA"]],
    "ZP": [newInternalIdToSrId["ZP"]],
    "ZR": [newInternalIdToSrId["ZR"]],
    "ZDW": [newInternalIdToSrId["ZDW"]],
    "ZG": [newInternalIdToSrId["ZG"]],
    "ZG_PN": [newInternalIdToSrId["ZG_PN"]],
    "ZS": [newInternalIdToSrId["ZS"]],
};

export const stationPositions: {[x: number]: number[]} = {
    [StationId.baby]:                           [19.717187, 51.538282],
    [StationId.belchow]:                        [20.033494, 52.026046],
    ...
    [StationId.gajewniki]:                      [18.983129, 51.612811],
    [StationId.galkowek]:                       [19.731778, 51.729788],
    [StationId.glinnik]:                        [19.495132, 51.886605],
    [StationId.glowno]:                         [19.702507, 51.959665],
    ...
    [StationId.lask]:                           [19.108786, 51.604103],
    [StationId.lazy_la]:                        [19.420255, 50.453892],
    [StationId.lazy_lc]:                        [19.362862, 50.416436],
    [StationId.lazy]:                           [19.391998, 50.430172],
    [StationId.lodz_kaliska]:                   [19.430088, 51.757714],
    [StationId.lodz_chojny]:                    [19.494985, 51.725217],
    [StationId.lodz_lublinek]:                  [19.358181, 51.719826],
    [StationId.lodz_widzew]:                    [19.543928, 51.763177],
    [StationId.lodz_zabieniec]:                 [19.405852, 51.797350],
    [StationId.lowicz_glowny]:                  [19.956626, 52.104493],
    [StationId.lowicz_przedmiescie]:             [19.948651, 52.093110],
    ...
    [StationId.pabianice]:                      [19.322163, 51.659661],
    ...
    [StationId.rokiciny]:                       [19.780980, 51.669084],
    [StationId.retkinia]:                       [19.415163, 51.742761],
    ...
    [StationId.witonia]:                        [19.276902, 52.156850],
    ...
    [StationId.zdunska_wola]:                   [18.942019, 51.611250],
    [StationId.zgierz]:                         [19.421290, 51.844430],
    [StationId.zgierz_polnoc]:                  [19.384474, 51.869032],
