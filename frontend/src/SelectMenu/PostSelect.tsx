    ...
    >
        {
            ...
            : (posts.length === 0)
                ...
                : posts
                    ...
                    .map((post) => <PostCard key={post.id} post={post} isWebpSupported={isWebpSupported} controllingPlayer={players?.find(player => player.steamid === post.DispatchedBy?.[0]?.SteamId)}/>)
        }
    </SelectMenuLayout>;
}
