...
export const postConfig: Dictionary<StationConfig> = {
    ...
    SK: {
        ...
        secondaryPosts: ["SK_GT_201_208", "SK_M_PZS", "SK_P_PZS", "SK_S_PZS"]
    },
    SK_GT_201_208: {
        id: "SK_GT_201_208",
        srName: "Skierniewice GT 201-208",
        trainPosRange: 0.5
    },
    SK_M_PZS: {
        id: "SK_M_PZS",
...
export type InterlockingType = "computer" | "relay";

export const interlockingTypes: Partial<Record<string, InterlockingType>> = {
    GW: "computer",
    PS: "computer",
    KN: "computer",
    WP: "computer",
